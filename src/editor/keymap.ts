...
export const BINDINGS: readonly Binding[] = [
  ...
  // Typora leaves ticking a box unbound; this keeps it next to the key that
  // makes the list, in the shape of the strikethrough chord.
  { chord: "Alt+Shift+x", command: "toggleTask" },
